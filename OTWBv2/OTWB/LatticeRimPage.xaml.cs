...
namespace OTWB
{
    ...
    /// </summary>
    public sealed partial class LatticeRimPage : OTWB.Common.LayoutAwarePage
    {
        ViewModel viewModel;

        public LatticeRimPage()
        {
        ...
        private void Grid_Click(object sender, RoutedEventArgs e)
        {
            ...
            gc.DataContext = LatticeRimPathDisplay.Grid;
            gc.Background = LatticeRimPathDisplay.CanvasBackgroundBrush;
            ...
            settings.HeaderBrush = new SolidColorBrush(LatticeRimPathDisplay.Grid.Foreground);
            settings.HeaderText = "Grid Size"; // string.Format("{0}", App.VisualElements.DisplayName);
            settings.ContentBackgroundBrush = LatticeRimPathDisplay.CanvasBackgroundBrush;
        ...
        {
            if (LatticeRimPathDisplay.CurrentPath == null) return;
            SettingsFlyout settings = new SettingsFlyout();
            // set the desired width.  If you leave this out, you will get Narrow (346px)
            ...
            pc.DataContext = LatticeRimPathDisplay.CurrentPath.AllPoints;
            //pc.SelectedPath = 0;
            settings.Content = pc;
            // open it
            settings.IsOpen = true;
        ...
        private async void GeneratePaths()
        {
            ...
            await this.Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, () =>
            {
                ...
                LatticeRimPathDisplay.CurrentPath = viewModel.CurrentPath;
                LatticeRimPathDisplay.ShowPaths();
            });
        ...
        private void Button_Click_2(object sender, RoutedEventArgs e)
        {
            ...
            //BigDisplayButton.Visibility = Windows.UI.Xaml.Visibility.Visible;
        }
        ...
        private void ToggleButton_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            LatticeRimPathDisplay.Showgrid = (bool)tb.IsChecked;
        }
